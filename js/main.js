...
var computerWin;
    ...
    scissors.onclick = function () {
        ...
        setTimeout(function(){computerChoice('Match null', 'L\'ordi gagne', 'Vous gagne');},1500)
    ...
    leaf.onclick = function () {
        ...
        setTimeout(function(){computerChoice('ordi gagne', 'vous gagne', 'match null');},1500)
    ...
    document.getElementById('rock').onclick = function () {
        ...
        userChoice = this.alt;
            ...
            setTimeout(function(){computerChoice('vous gagne', 'match null', 'ordi gagne');},1500)
    ...
    setTimeout(function(){document.getElementById('user').value = userChance;},1000)
